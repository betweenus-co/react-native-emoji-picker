    ...
    return (_jsx(View, { style: [
            ...
            containerStyle
                ...
                searchBarStyle
                    ...
                    const SearchIcon = SearchIconComponent !== null && SearchIconComponent !== void 0 ? SearchIconComponent : DefaultSearchIcon;
                    return (_jsx(SearchIcon, { size: ICON_SIZE, color: themedColors.searchIcon, style: [styles.searchIcon, { marginRight: ICON_MARGIN }] }));
...
const styles = StyleSheet.create({
    ...
    input: Object.assign({ flex: 1 }, Platform.select({
        web: {
            outlineStyle: 'solid',
            outlineWidth: 0,
        },

...
export const groupEmojisByCategory = (emojis) => {
...
export const getRecentlyUsedEmojis = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
export const saveRecentlyUsedEmoji = (emoji) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Get current recents
        const current = yield getRecentlyUsedEmojis();
...
export const createEmojiSectionsWithRecents = (emojis) => __awaiter(void 0, void 0, void 0, function* () {
    // Get recently used emojis
    const recentEmojiCodes = yield getRecentlyUsedEmojis();
